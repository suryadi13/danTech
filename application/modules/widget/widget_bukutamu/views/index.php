			<div class="row bukutamu" style="margin-top:<?=$opsi[0]->nilai;?>px;"><div class="col-lg-12">
				<div class="panel panel-primary">
                        <div class="panel-heading"><i class="fa fa-calendar fa-fw"></i> BUKUTAMU</div>
...
//$('#kTab_1').html("<img src='<?=site_url();?>assets/images/loading1.gif'>");
			$.ajax({
				...
				data:{ "hal": hal,"batas": <?=@$opsi[2]->nilai;?>,"idd": 0},
				success:function(data){
