...
//////////////////////////////////////////////////////////////////////////////////
	...
	function simpan_slider($idd,$nama,$komponen){
		$query=$this->db->query("SELECT MAX(urutan_appe) as count_nik FROM konten_appe WHERE id_konten='$idd' AND tipe='artikel_slider'"); 
		$row = $query->row_array();		$max = $row['count_nik']+1;

		$sqlstr="INSERT INTO konten_appe (id_konten,tipe,foto,urutan_appe) 
		VALUES ('$idd','artikel_slider','$nama','$max')";		
