...
class Formadmin extends MX_Controller {
	...
	public function tambah()	{
			...
			$rbk = $this->m_slider->getkategori_by_komponen("artikel");
			$data['pilisi']="";
...
///////////////////////////////////////////////////////////////////////////////////
	public function formfitur($id_widget,$id_kategories,$opsi){
		...
		$data['daftar'] = $this->m_slider->getwidget($id_widget,$id_kategories,$opsi[2]->nilai);
		foreach($data['daftar'] as $it=>$val){
			@$data['daftar'][$it]->hari = $hh[$val->hari];

			$cek2 = $this->m_slider->sliderkonten($val->id_konten);
			if(!empty($cek2)){
	...
	public function form_upload(){
		...
		$cek2 = $this->m_slider->sliderkonten($_POST['idd']);
		if(!empty($cek2)){
			$data['dcek'] = "ada";
