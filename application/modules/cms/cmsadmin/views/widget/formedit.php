<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-success">
			<div class="panel-heading">FORM EDIT JENIS WIDGET</div>
...
<table class="table table-striped">
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_widget" name="nama_widget" class="form-control pt_text" value="<?=$isi->nama_item;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Keterangan</td>
          <td colspan="3">
		  <input type="text" id="keterangan" name="keterangan" class="form-control pt_text"  value="<?=$keterangan;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
...
////////////////////////////////////////////////////////////////////////////
	function simpan(){
		...
		if (hasil!=false) {
			$.ajax({
				type:"POST",
				url:"<?=base_url();?>cmsadmin/widget/edit_aksi/",
