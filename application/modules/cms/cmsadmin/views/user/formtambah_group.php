<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-success">
			<div class="panel-heading">FORM TAMBAH GRUP PENGGUNA</div>
			<div class="panel-body">
    <form id="content-form" method="post" action="<?=site_url('cmsadmin/user/tambah_group_aksi');?>" enctype="multipart/form-data">
...
<table class="table table-striped">
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_grup" name="nama_grup"  class="form-control" value="Wajib diisi" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Theme</td>
