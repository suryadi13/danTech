<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-success">
			<div class="panel-heading">FORM EDIT PENULIS BERITA</div>
...
<table class="table table-striped">
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_penulis" name="nama_penulis" class="form-control ipt_text" value="<?=$isi->nama_item;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
        <tr>
          <td>Keterangan</td>
          <td colspan="3">
		  <input type="text" id="keterangan" name="keterangan" class="form-control ipt_text"  value="<?=$isi->meta_value;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
       <tr >
          <td>&nbsp;</td>
...
////////////////////////////////////////////////////////////////////////////
	function simpan(){
		...
		if (hasil!=false) {
			$.ajax({
				type:"POST",
				url:"<?=base_url();?>cmsadmin/penulis/edit_aksi/",
