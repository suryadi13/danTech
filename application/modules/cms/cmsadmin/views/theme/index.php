<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Theme Website</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
								...
								<div class="col-lg-12">
									<div class="dropdown"><button class="btn btn-primary dropdown-toggle btn-xs" type="button" id="ddMenuT" data-toggle="dropdown"><span class="fa fa-book fa-fw"></span></button>
										<ul class="dropdown-menu" role="menu" aria-labelledby="ddMenuT">
											<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onclick="loadForm('formtambah','xx');"><i class="fa fa-plus fa-fw"></i> Tambah Theme Website</a></li>
										</ul>
										Daftar Theme Website
									</div>
								</div><!---/.col-lg-12 -->
						</div><!---/.row -->
			</div>
