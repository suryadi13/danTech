            ...
            <div class='col-md-12'>
              <div class='panel panel-info'>
                <div class='panel-heading'>
                  <b>FORM NAIKKAN KOMENTAR</b>
				  <div class="btn btn-warning btn-xs pull-right" onclick="batal(); return false;"><i class="fa fa-close fa-fw"></i></div>
                </div><!-- /.box-header -->
                <div class='panel-body'>
    <form id="content-form" method="post" action="<?=base_url();?>cmskonten/comment/dorong_aksi" enctype="multipart/form-data">
       ...
       <tr >
			...
			<td colspan="3">
				<input type=hidden name=id_komentar value='<?=@$isi->id_komentar;?>'>
					<div class="btn btn-primary btn-xl" onclick="simpan(); return false;"><i class="fa fa-upload fa-fw"></i> Naikkan</div>
