	...
	<td>
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li class="divider"></li>
				<?php } ?>
				<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onclick="hapus_foto(<?=$val->id_appe;?>);"><i class="fa fa-trash fa-fw"></i> Hapus lampiran</a></li>
			</ul>
		</div>
	</td>
	<td id="kolom_foto_<?=$val->id_appe;?>"><?=$val->foto;?></td>
	<td><div id='judul_appe_<?=$val->id_appe;?>' onclick="edit_judul_appe(<?=$val->id_appe;?>,'judul_appe');"><?=($val->judul_appe=="")?"...":$val->judul_appe;?></div></td>
</tr>
<?php
}	}
?>