...
var id_konten = $('#id_konten_ini').html();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>cmskonten/artikel/lampiran_insert",
...
var idd = $('#id_media').html();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>cmskonten/artikel/lampiran_hapus",
...
var id_konten = $('#id_konten_ini').html();
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>cmskonten/artikel/lampiran_urutan",
...
function satuket(idd,kolom){
	...
	if(ii_judul==""){	var isi_judul="...";	} else {	var isi_judul=ii_judul;	}
			$.ajax({
				type:"POST",
				url:"<?=site_url();?>cmskonten/artikel/foto_judul_aksi",
