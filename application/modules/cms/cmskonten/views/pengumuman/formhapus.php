...
<form role="form" id="form_tt" action="<?=site_url();?>cmskonten/artikel/hapus_aksi">
          <div class='row'>
            <div class='col-md-12'>
              <div class='panel panel-info'>
                <div class='panel-heading'>
                  <b>Form Hapus Pengumuman</b>
                ...
                <div class='panel-body'>
					...
					<div class="btn btn-danger btn-xl" onclick="simpan_aksi(); return false;"><i class="fa fa-edit fa-fw"></i> Hapus</div>
