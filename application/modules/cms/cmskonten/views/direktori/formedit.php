            ...
            <div class='col-md-12'>
              <div class='panel panel-info'>
                <div class='panel-heading'>
                  <b>FORM EDIT ITEM DIREKTORI</b>
				  <div class="btn btn-warning btn-xs pull-right" onclick="batal(); return false;"><i class="fa fa-close fa-fw"></i></div>
                </div><!-- /.box-header -->
                <div class='panel-body'>


    <form id="content-form" method="post" action="<?=site_url();?>cmskonten/direktori/edit_aksi" enctype="multipart/form-data">
...
<table class="table table-striped">
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_direktori" name="nama_direktori"  class="ipt_text" style="width:400px;" value="<?=@$ini[0]->judul;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
		  </td>
        </tr>
<?php
$urutan=1;
...
?>
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id='isi_atribut_<?=$urutan;?>' name="isi_atribut[]" class="ipt_text" style="width:400px;" value="<?=$nilai;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';">
