            ...
            <div class='col-md-12'>
              <div class='panel panel-danger'>
                <div class='panel-heading'>
                  <b>FORM HAPUS ITEM POLLING</b>
				  <div class="btn btn-warning btn-xs pull-right" onclick="batal(); return false;"><i class="fa fa-close fa-fw"></i></div>
                </div><!-- /.box-header -->
                <div class='panel-body'>
    <form id="content-form" method="post" action="<?=site_url();?>cmskonten/polling/hapus_aksi" enctype="multipart/form-data">
...
<table class="table table-striped">
        ...
        <tr>
          <td>Keterangan</td>
          <td colspan="3">
		  <input type="text" id="isi" name="isi" class="form-control" value="<?=$isi->isi_konten;?>" disabled>
		  </td>
        </tr>
        <tr>
