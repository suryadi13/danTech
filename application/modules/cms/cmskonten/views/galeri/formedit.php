            ...
            <div class='col-md-12'>
              <div class='panel panel-info'>
                <div class='panel-heading'>
                  <b>FORM EDIT ITEM GALERI</b>
				  <div class="btn btn-warning btn-xs pull-right" onclick="batal(); return false;"><i class="fa fa-close fa-fw"></i></div>
                </div><!-- /.box-header -->
                <div class='panel-body'>
    <form id="content-form" method="post" action="<?=base_url();?>cmskonten/galeri/edit_aksi" enctype="multipart/form-data">
...
<table class="table table-striped">
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="tgl_buat" name="tgl_buat" class="form-control" value="<?=@$isi->tanggal;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';" placeholder="dd-mm-YYY">
		  </td>
        </tr>
        <tr>
          <td>Keterangan</td>
